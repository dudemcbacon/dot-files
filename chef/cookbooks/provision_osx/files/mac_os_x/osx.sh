...
# With tweaks added and removed by Brandon because I'm cool.
...
echo "What would you like the hostname of this system to be?"

read $local_hostname

# Set computer name (as done via System Preferences → Sharing)
sudo scutil --set ComputerName $local_hostname
...
# Pin dock to the left side of the screen:
